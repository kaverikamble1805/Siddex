!(function (e, t) {
   ...
   */ let e,
    ...
    function ie() {
        var e;
        if (
            ((e = x), (B.innerHTML = e), (g = B.querySelectorAll("img")), g.length)
        ) {
            let e = 0;
            W(g, function (t) {
                let o = t.src;
    ...
    function ae(e) {
        if (!y) {
            ...
            ((a.style.transition =
                ...
                (D = Q = "touchstart" === e.type ? e.touches[0].pageX : e.pageX),
    ...
    function le(e) {
        if (Y && !y) {
            ((Q = "touchmove" === e.type ? e.touches[0].pageX : e.pageX),
    ...
    function de(e) {
        ...
        (e.settings.share &&
            ...
            (f = document.querySelectorAll('.vbox-item[data-gall="' + z + '"]')),
            (l = Array.prototype.indexOf.call(f, e)),
            f.length < 2 && (h = !1),
            f.length < 3 && (m = !1),
            (j = f[l + 1]),
            (H = f[l - 1]),
    ...
    return (
        ...
        jQuery.fn.extend({
            venobox: function (e) {
                const t = e || {};
                ((t.jQuerySelectors = this), new pe({ pluginoptions: t }));
            },
        }),
        pe
    );
